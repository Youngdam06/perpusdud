            ...
            <div class="table-responsive p-0">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('kelolaKategori.destroy',$kategori->id) }}" method="POST">
                            <div class="align-middle text-center text-sm">
                                <a class="btn btn-info" href="{{ route('kelolaKategori.edit',$kategori->id) }}">Edit</a>
                ...
                <div class="container">
                    <a class="btn bg-primary btn-dark" href="{{ route('kelolaKategori.create') }}">Tambah data</a>
                </div>
            </div>
            </div>
        </div>
